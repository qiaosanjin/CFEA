# -*- coding:utf-8 -*-
import sys
sys.path.append('/data3/qiaoxin/codeset/Remote-Sensing-Image-Classification-master')
import os
import cv2
import pandas as pd
import numpy as np
...
if __name__ == '__main__':
    ...
    dst_train = RSDataset('./huitu/data-ucm/train.txt', width=256, height=256, transform=transform)
